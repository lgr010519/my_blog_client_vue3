...
const avatarBg = require('../assets/avatarBg.png')
			...
			<div class="friend-link-box">
				...
				<div class="friend-links">
					<a href="https://github.com" target="_blank">
						<el-button circle>
							<el-avatar size="40" src="../assets/github.png"/>
						</el-button>
					</a>
					<a href="https://segmentfault.com" target="_blank">
						<el-button circle>
							<el-avatar size="40" src="../assets/sf.jpeg"/>
						</el-button>
					</a>
					<a href="https://www.zhihu.com" target="_blank">
						<el-button circle>
							<el-avatar size="40" src="../assets/zhihu.jpg"/>
						</el-button>
					</a>
				</div>
			</div>
